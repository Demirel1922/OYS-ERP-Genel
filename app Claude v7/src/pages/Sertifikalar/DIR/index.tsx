...
export default function DIRPage() {
  ...
  // DİR alt modüllerini getir (parent: '11a')
  const childModules = getChildModules('11a');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">DİR (Dahilde İşleme Rejimi)</h1>
          <p className="text-gray-600 mt-2">
            Dahilde İşleme Rejimi belge takibi ve yönetimi
          </p>
        </div>
