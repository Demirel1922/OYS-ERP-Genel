...
import { Plus, Edit, Trash2, Search, Shirt, ArrowLeft, Ruler, Users } from 'lucide-react';
...
const LOOKUP_TYPES: { id: LookupType; label: string; icon: React.ElementType; description: string }[] = [
  ...
  { id: 'TIP', label: 'Tipler', icon: Shirt, description: 'Çorap tipleri (Patik, Kısa, Diz Altı vb.)' },
